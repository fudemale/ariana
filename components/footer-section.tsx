      ...
      <div className="self-stretch h-auto flex flex-col md:flex-row justify-between items-stretch pr-0 pb-8 pt-0">
        <div className="h-auto p-4 md:p-8 flex flex-col justify-start items-start gap-8">
          ...
          <div className="flex justify-start items-start gap-4 text-foreground">
            {/* Twitter/X Icon */}
            <a href="https://twitter.com" className="w-6 h-6 relative overflow-hidden hover:text-primary transition-colors">
            ...
            {/* LinkedIn Icon */}
            <a href="https://linkedin.com" className="w-6 h-6 relative overflow-hidden hover:text-primary transition-colors">
              <div className="w-6 h-6 left-0 top-0 absolute flex items-center justify-center">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            {/* GitHub Icon */}
            <a href="https://github.com" className="w-6 h-6 relative overflow-hidden hover:text-primary transition-colors">
              <div className="w-6 h-6 left-0 top-0 absolute flex items-center justify-center">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path
