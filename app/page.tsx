...
import { HowBillingWorks } from "../components/how-billing-works"
              ...
              <div className="w-full max-w-[calc(100%-32px)] sm:max-w-[calc(100%-48px)] md:max-w-[calc(100%-64px)] lg:max-w-[700px] lg:w-[700px] h-10 sm:h-11 md:h-12 py-1.5 sm:py-2 px-3 sm:px-4 md:px-4 pr-2 sm:pr-3 bg-[#F7F5F3] backdrop-blur-sm shadow-[0px_0px_0px_2px_white] overflow-hidden rounded-[50px] flex justify-between items-center relative z-30">
                <div className="flex justify-center items-center">
                  <div className="flex justify-start items-center">
                    <div className="flex flex-col justify-center text-[#2F3037] text-sm sm:text-base md:text-lg lg:text-xl font-medium leading-5 font-sans text-slate-700 bg-muted">
                      Arianainsta
                    </div>
                  </div>
              ...
              <div className="w-full max-w-[937px] lg:w-[937px] flex flex-col justify-center items-center gap-3 sm:gap-4 md:gap-5 lg:gap-6">
                <div className="self-stretch rounded-[3px] flex flex-col justify-center items-center gap-4 sm:gap-5 md:gap-6 lg:gap-8">
                  ...
                  <div className="w-full max-w-[506.08px] lg:w-[506.08px] text-center flex justify-center flex-col text-[rgba(55,50,47,0.80)] sm:text-lg md:text-xl leading-[1.4] sm:leading-[1.45] md:leading-[1.5] lg:leading-7 font-sans px-2 sm:px-4 md:px-0 lg:text-lg font-medium text-sm">
                    Schedule posts, analyze engagement, and grow your audience
                    <br className="hidden sm:block" />
                    with ArianaInsta's powerful automation platform.
                  </div>
                </div>
              </div>
              ...
              <div className="self-stretch border-t border-[#E0DEDB] border-b border-[#E0DEDB] flex justify-center items-start">
                ...
                <div className="flex-1 px-0 sm:px-2 md:px-0 flex flex-col md:flex-row justify-center items-stretch gap-0">
                  ...
                  <FeatureCard
                    ...
                    description="Plan your Instagram content calendar and schedule posts weeks ahead for consistent engagement."
                  ...
                  <FeatureCard
                    ...
                    description="Track follower growth, engagement rates, and audience insights in real-time with detailed reports."
                  ...
                  <FeatureCard
                    ...
                    description="Automatically interact with your audience, respond to comments, and build meaningful connections."
              ...
              <div className="w-full border-b border-[rgba(55,50,47,0.12)] flex flex-col justify-center items-center">
                ...
                <div className="self-stretch border-[rgba(55,50,47,0.12)] flex justify-center items-start border-t border-b-0">
                  ...
                  <div className="flex-1 grid grid-cols-2 sm:grid-cols-4 md:grid-cols-4 gap-0 border-l border-r border-[rgba(55,50,47,0.12)]">
                    {/* Instagram Growth Showcase - Responsive grid */}
                    {[
                      {
                        title: "Schedule Posts",
                        image: "/instagram-scheduling-calendar-interface.jpg",
                      },
                      {
                        title: "Track Analytics",
                        image: "/instagram-analytics-graphs-engagement-metrics.jpg",
                      },
                      {
                        title: "Grow Audience",
                        image: "/instagram-follower-growth-chart.jpg",
                      },
                      {
                        title: "Auto Engagement",
                        image: "/instagram-engagement-automation-interface.jpg",
                      },
                      {
                        title: "Content Calendar",
                        image: "/instagram-content-planning-calendar.jpg",
                      },
                      {
                        title: "Trending Insights",
                        image: "/instagram-trending-content-insights-dashboard.jpg",
                      },
                      {
                        title: "Hashtag Research",
                        image: "/instagram-hashtag-research-tool-interface.jpg",
                      },
                      {
                        title: "Report Builder",
                        image: "/instagram-performance-report-analytics.jpg",
                      },
                    ].map((item, index) => {
                      ...
                      return (
                        <div
                          key={index}
                          className={`
                            h-24 xs:h-28 sm:h-32 md:h-36 lg:h-40 flex flex-col justify-center items-center gap-1 xs:gap-2 sm:gap-3 p-3 sm:p-4
                            ...
                            border-[#E3E2E1] hover:bg-[rgba(55,50,47,0.02)] transition-colors duration-200 cursor-pointer
                          `}
                        >
                          <img
                            src={item.image || "/placeholder.svg"}
                            alt={item.title}
                            className="w-8 h-8 xs:w-10 xs:h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-lg object-cover shadow-md"
                          />
                          <div className="text-center flex justify-center flex-col text-[#37322F] text-xs xs:text-sm sm:text-base md:text-sm font-medium leading-tight md:leading-tight font-sans">
                            {item.title}
                          </div>
                        </div>
                      )
              ...
              <div className="w-full border-b border-[rgba(55,50,47,0.12)] flex flex-col justify-center items-center">
                ...
                <div className="self-stretch px-4 sm:px-6 md:px-8 lg:px-0 lg:max-w-[1060px] lg:w-[1060px] py-8 sm:py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
                  <div className="w-full max-w-[616px] lg:w-[616px] px-4 sm:px-6 py-4 sm:py-5 shadow-[0px_2px_4px_rgba(50,45,43,0.06)] overflow-hidden rounded-lg flex flex-col justify-start items-center gap-3 sm:gap-4 shadow-none">
                    ...
                    <div className="self-stretch text-center text-[#605A57] text-sm sm:text-base font-normal leading-6 sm:leading-7 font-sans">
                      Streamline your Instagram strategy with tools designed for modern creators and brands to maximize
                      their reach.
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-0 border-l border-r border-[rgba(55,50,47,0.12)]">
                    ...
                    <div className="border-r-0 md:border-r border-[rgba(55,50,47,0.12)] p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-start items-start gap-4 sm:gap-6 bg-transparent">
                      <div className="flex flex-col gap-2">
                        ...
                        <p className="text-[#605A57] text-sm md:text-base font-normal leading-relaxed font-sans">
                          Plan and organize your content strategy across multiple platforms with an intuitive
                    ...
                    <div className="p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-start items-start gap-4 sm:gap-6">
                      <div className="flex flex-col gap-2">
                        ...
                        <p className="text-[#605A57] text-sm md:text-base font-normal leading-relaxed font-sans">
                          Watch your follower count grow with predictive analytics and insights into what your audience
                          loves most.
                        </p>
                      </div>
