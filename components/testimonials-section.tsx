...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "arianainsta has completely transformed how we manage our Instagram presence. The scheduling and analytics features save us hours every week!",
      name: "Jamie Marshall",
    ...
    {
      quote:
        "arianainsta has revolutionized how we handle Instagram growth. The automation saves us hours every week and ensures consistent engagement.",
      name: "Sarah Chen",
    ...
    {
      quote:
        "The Instagram automation with arianainsta is a game-changer. What used to take our team hours now happens automatically with perfect timing and engagement.",
